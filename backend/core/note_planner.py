...
ALLOWED_PLAN_NOTE_MODES: Final[set[str]] = {"direct", "high_fidelity"}
...
- recommended_note_mode: direct, high_fidelity
...
- 很长、信息密度高、要求尽量完整覆盖的课程/讲座/复杂资料：high_fidelity。
- transcript_preview 可能包含材料统计、开头样本、中段样本和结尾样本；判断时不要只看开场寒暄，要综合三段的信息密度和结构。
- 会议纪要类材料优先 meeting。
