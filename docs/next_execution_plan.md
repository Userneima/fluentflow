...
- [ ] Convert `/processing` from a parameter panel into an Agent workflow view: initial plan, post-transcription plan, selected tools, judgment basis, and current status.
