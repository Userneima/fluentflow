...
export const resultDisplayTitle = (result={}, fallback={}) => (
    displayTitleForUser(
        result.display_title || fallback.displayTitle || result.raw_title || fallback.rawTitle || result.filename || fallback.name,
        result.filename || fallback.rawFilename || fallback.name,
    )
);
