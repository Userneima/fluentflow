...
export const msgs = {
  en:{
    'nav.subtitle':'Video-to-Lark AI','nav.dashboard':'Start','nav.tasks':'History','nav.processing':'Agent Workflow','nav.editor':'Editor','nav.settings':'Settings','nav.admin':'Admin','nav.newProject':'New Project','nav.search':'Search projects...','nav.projects':'Projects','nav.integrations':'Integrations',
  ...
  zh:{
    'nav.subtitle':'视频转飞书 AI','nav.dashboard':'开始处理','nav.tasks':'历史记录','nav.processing':'Agent 工作流','nav.editor':'编辑器','nav.settings':'设置','nav.admin':'管理','nav.newProject':'新建项目','nav.search':'搜索项目…','nav.projects':'项目','nav.integrations':'集成',
